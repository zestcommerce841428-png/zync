...
export default function AcceptableUsePage(): React.ReactElement {
  return (
    <PageShell title="Acceptable Use Policy" updated="June 2026">
      ...
      <Typography variant="h2" component="h2">You must not use {brand.name} to</Typography>
      <ul>
        <li>Share content you do not have the legal right to distribute, including pirated or copyright-infringing material.</li>
        <li>Distribute malware, viruses, ransomware, or other harmful code.</li>
        <li>Share illegal content, including child sexual abuse material (CSAM), which we report to the appropriate authorities.</li>
        <li>Harass, threaten, defame, or violate the privacy or rights of others.</li>
        <li>Transmit content that incites violence or unlawful acts.</li>
        <li>Attempt to disrupt, overload, reverse-engineer, or abuse the Service or its infrastructure.</li>
        <li>Circumvent rate limits or security measures.</li>
      </ul>

      <Typography variant="h2" component="h2">Reporting abuse</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">Enforcement</Typography>
      <Typography component="p">
        ...
        <a href="/terms">Terms of Service</a> and <a href="/dmca">DMCA Policy</a>.
      </Typography>
    </PageShell>
  )
}
