...
export default function TermsPage(): React.ReactElement {
  return (
    <PageShell title="Terms of Service" updated="June 2026">
      ...
      <Typography variant="h2" component="h2">1. The Service</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">2. Acceptable use</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">3. No warranty</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">4. Limitation of liability</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">5. Termination</Typography>
      <Typography component="p">
      ...
      <Typography variant="h2" component="h2">6. Changes</Typography>
      <Typography component="p">
        We may update these Terms from time to time. Continued use after changes
        constitutes acceptance of the revised Terms.
      </Typography>

      <Typography variant="h2" component="h2">7. Contact</Typography>
      <Typography component="p">
        Questions? Email{' '}
